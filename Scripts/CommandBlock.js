 ...
 *   _____                                          _ ____  _            _    
 *  / ____|                                        | |  _ \| |          | |   
 * | |     ___  _ __ ___  _ __ ___   __ _ _ __   __| | |_) | | ___   ___| | __
 * | |    / _ \| '_ ` _ \| '_ ` _ \ / _` | '_ \ / _` |  _ <| |/ _ \ / __| |/ /
 * | |___| (_) | | | | | | | | | | | (_| | | | | (_| | |_) | | (_) | (__|   < 
 *  \_____\___/|_| |_| |_|_| |_| |_|\__,_|_| |_|\__,_|____/|_|\___/ \___|_|\_\
 *
 * === ABOUT US ===
 * @name:		CommandBlock by Orbitron
 * @website:	http://www.team-orbitron.com
 * === ABOUT PROJECT ===
 * @author:		Orbitron
 * @version:	v1.0.0
 * @website:	http://store.team-orbitron.com/mcpe-scripts/CommandBlock.js
 *
 * Testet with:
 * MCPE: v0.8.1
...
{
	if(ents.indexOf(entity) != -1)
	{
		ents.splice(ents.indexOf(entity));
	}
}
